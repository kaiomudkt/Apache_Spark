...
# verifique neste link https://dlcdn.apache.org/spark/ a versão disponivel SPARK_VERSION e HADOOP_VERSION
...
RUN mkdir -p /home/${UNAME}/app \
    && chown -R ${UID}:${GID} /home/${UNAME}/app \
    && mkdir -p /home/${UNAME}/app/spark_events \
    && chown -R ${UID}:${GID} /home/${UNAME}/app/spark_events
